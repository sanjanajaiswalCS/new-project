    ...
    <div className="flex flex-col items-center justify-center  min-h-screen bg-gray-100 px-6 py-12">
      ...
      <div className="max-w-7xl  rounded-2xl p-8 text-center">
        ...
        <div className="text-left text-gray-600  space-y-4">
          ...
          <p>Welcome to AtYourServiceSupport.com. Our Terms of Service govern your use of our website and services. By accessing or using our Services, you agree to comply with these Terms. If you do not agree, please do not use our Services.
          </p>
          ...
          <div className="flex flex-col items-center justify-center text-center p-6"> 
            ...
            <p className="text-xs font-medium">UDYAM-MH-18-0420836</p> 
            <p className="text-xs font-medium">Owner Name: Abhishek Jaiswal</p> 
